...
class searchMerchantUsecase @Inject constructor(
    ...
    suspend fun loadData(searchQuery : String,page : Int) : Flow<Resource<List<Merchant>>>{
        return flow{
            ...
            try {
                ...
                val merchantDataWithName = merchantRepository.searchMerchants(searchQuery, Constant.QUERY_PAGE_SIZE,Constant.QUERY_PAGE_SIZE * (page-1))
