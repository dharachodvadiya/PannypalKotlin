...
class searchMerchantNameAndDetailsUsecase @Inject constructor(
    ...
    suspend fun loadData(searchQuery : String, page : Int) : Flow<Resource<List<MerchantNameAndDetails>>>{
        return flow{
            ...
            try {
                ...
                val merchantDataWithName = merchantRepository.searchMerchantsNameAndDetails(searchQuery, Constant.QUERY_PAGE_SIZE,Constant.QUERY_PAGE_SIZE * (page-1))
