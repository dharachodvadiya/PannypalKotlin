...
class GetMerchantDataListWithMerchantNameAndDayTotalUseCase @Inject constructor(
    ...
    fun loadData(): Flow<PagingData<MerchantDataWithNameWithDayTotal>> {
        ...
        return Pager(
            ...
            merchantDataRepository.getMerchantDataWithNameWithDayTotal(Util.TIME_ZONE_OFFSET_IN_MILLI)
        }
            .flow
            .flowOn(dispatcher)
    }
