...
class SettingViewModel @Inject constructor(
    ...
    val generalList = getUserProfileWithPaymentUseCase
        ...
        .map { item ->
            ...
            currCurrencyCode = item.currency
            listOf(
                MoreItem(title = R.string.currency_and_format, subTitle = item.currency),
    ...
    fun onSelectOption(
        ...
        when(item.title)
        {
            R.string.currency_and_format -> onCurrencyChange(currCurrencyCode)
