...
class getMerchantNameAndDetailListUsecaseTest {
    ...
    @Test
    fun get_merchant_name_and_detail_list_with_page_test() = runBlocking{
        ...
        val result = getMerchantNameAndDetailListUsecase(merchantRepository, coroutineDispatcher).loadData(1)
